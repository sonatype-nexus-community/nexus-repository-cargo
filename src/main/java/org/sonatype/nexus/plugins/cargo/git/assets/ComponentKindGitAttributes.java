...
public class ComponentKindGitAttributes {
    ...
    public Component createGitComponent(Repository repository, String repo_name)
            throws IOException {
    ...
    public Component findGitComponent(Repository repository, String repo_name) throws IOException {
        ...
        Iterable<Component> components = tx.findComponents(
                Query.builder()
                        .where(ComponentEntityAdapter.P_GROUP).eq(I_GROUP_GIT)
                        .and(ComponentEntityAdapter.P_NAME).eq(repo_name)
                        .build(),
