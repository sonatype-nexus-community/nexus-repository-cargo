...
public class StoredConfig extends org.eclipse.jgit.lib.StoredConfig {
    ...
    public void save() throws IOException {
        ...
        asset_attributes.setContents(asset,
                IOUtils.toInputStream(this.toText(), StandardCharsets.UTF_8));
    }
