...
public class ObjectInserter extends org.eclipse.jgit.lib.ObjectInserter {
    ...
    public ObjectId insert(int object_type, long length, InputStream in) throws IOException {
        Asset asset = asset_attributes.createObjectAsset(this.bucket, this.component, object_type,
                length, in);
